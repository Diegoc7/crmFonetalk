                        ...
                        <div class="col-md-7 col-md-offset-5">
                            ...
                            <div class="tab-content">
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="buzz">
                                    <br/>
                                    <form id="form-insert-activity" class="form-horizontal">
                                        <div class="col-sm-12">
                                            <div class="form-group-material">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group-material">
                                                <input id="assunto" placeholder="Teste" type="text" name="assunto" required="required" class="" maxlength="100"  >
                                                <label for="assunto" class="label-material">Assunto </label>
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group-material">
                                                <input id="dataAgenda" type="text" name="data"  class="input-material dataFormato" maxlength="100"  >
                                                <label for="dataAgenda" class="label-material">Data</label>
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group-material">
                                                <input id="horaAgenda" type="text" name="horaAgenda"  class="input-material" maxlength="100"  >
                                                <label for="horaAgenda" class="label-material">Hora </label>
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group-material">
                                                <select id="tipoNegocios" name="tipoNegocios"   class="selectpicker form-control  show-tick" data-live-search="true" title="Selecione um tipo" >
                                                    <option value="" ></option>
                                                </select>
                                            </div>
                                        </div>

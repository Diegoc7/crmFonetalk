...
function buscaInfoNegociosUser(id) {
    $.ajax({
        ...
        success: function (json) {
            console.log(json);
            if (json != 'vazio') {
                $('#numeroCliente').html(json['qtd_contatos']);
...
//                data: passar,
    ...
    function montaEdit(value, index, ar) {
        ...
        $('#empresaEdit').val(value.empresa);
        $('#idBuscaEmpresaEdit').val(value.id_empresa);
...
//        $('#contatoEdit').selectpicker('val', value.id_contato);
        $('#contatoEdit').val(value.contato);
        $('#idBuscaContatoEdit').val(value.id_contato);
        $('#cargoEdit').val(value.cargo);
...
//                data: passar,
    ...
    function montaEditAtividade(value, index, ar) {
        ...
        $('#contatoEdit').val(value.contato);
        $('#idBuscaContatoEdit').val(value.id_contato);
        $('#negocioEdit').val(value.negocio);
        $('#idBuscaNegocioEdit').val(value.id_negocio);
        $('#empresaEdit').val(value.empresa);
        $('#idBuscaEmpresaEdit').val(value.id_empresa);
...
$('#contato').keyup(function () {
    var tamanho = $("#contato").val().length;
    console.log(tamanho);
    if (tamanho > 3) {
        var busca = $("#contato").val();
        $.ajax({
            type: 'POST',
            url: 'http://192.168.1.61/crmFonetalk/empresas/buscaContato/' + busca,
            cache: false,
            dataType: 'json',
            success: function (json) {
                console.log(json);
                $("#respostaContato").find('ul').html('');
                json.forEach(montaContatosSeleciona);
                $('#respostaContato').slideDown('slow');
            },
            error: function (e) {//executa se der erro em algum lugar
                alert("erro ao deletar" + e);
            }
...
function montaContatosSeleciona(value, index, ar) {
    $("#respostaContato").find('ul').append('<li ><a onclick="escolhaContato(' + value.id + ', \' ' + value.nome + ' \', \' ' + value.cargo + ' \' );" >' + value.nome + '</a></li>');
}

function escolhaContato(id, nome, cargo) {
    $("#contato").val(nome);
    $("#idBuscaContato").val(id);
    $("#cargo").val(cargo);
    $('#respostaContato').slideUp('slow');
}

$('#contatoEdit').keyup(function () {
    var tamanho = $("#contatoEdit").val().length;
    console.log(tamanho);
    if (tamanho > 3) {
        var busca = $("#contatoEdit").val();
        $.ajax({
            type: 'POST',
            url: 'http://192.168.1.61/crmFonetalk/empresas/buscaContato/' + busca,
            cache: false,
            ...
            success: function (json) {
                console.log(json);
                $("#respostaContatoEdit").find('ul').html('');
                json.forEach(montaContatosSelecionaEdit);
                $('#respostaContatoEdit').slideDown('slow');
            },
            error: function (e) {//executa se der erro em algum lugar
                alert("erro ao deletar" + e);
            }
...
function montaContatosSelecionaEdit(value, index, ar) {
    $("#respostaContatoEdit").find('ul').append('<li ><a onclick="escolhaContatoEdit(' + value.id + ', \' ' + value.nome + ' \', \' ' + value.cargo + ' \' );" >' + value.nome + '</a></li>');
}

function escolhaContatoEdit(id, nome, cargo) {
    $("#contatoEdit").val(nome);
    $("#idBuscaContatoEdit").val(id);
    $("#cargoEdit").val(cargo);
    $('#respostaContatoEdit').slideUp('slow');
}

$('#empresa').keyup(function () {
    var tamanho = $("#empresa").val().length;
    console.log(tamanho);
    if (tamanho > 3) {
        var busca = $("#empresa").val();
        $.ajax({
            type: 'POST',
            url: 'http://192.168.1.61/crmFonetalk/contatos/buscaEmpresa/' + busca,
            cache: false,
            dataType: 'json',
            success: function (json) {
                console.log(json);
                $("#respostaEmpresa").find('ul').html('');
                json.forEach(montaEmpresasSeleciona);
                $('#respostaEmpresa').slideDown('slow');
            },
            error: function (e) {//executa se der erro em algum lugar
                alert("erro ao deletar" + e);
            }
...
function montaEmpresasSeleciona(value, index, ar) {
    $("#respostaEmpresa").find('ul').append('<li ><a onclick="escolhaEmpresa(' + value.id + ', \' ' + value.nome + ' \', \' ' + value.cargo + ' \' );" >' + value.nome + '</a></li>');
}

function escolhaEmpresa(id, nome, cargo) {
    $("#empresa").val(nome);
    $("#idBuscaEmpresa").val(id);
    $("#cargo").val(cargo);
    $('#respostaEmpresa').slideUp('slow');
}
$('#empresaEdit').keyup(function () {
    var tamanho = $("#empresaEdit").val().length;
    console.log(tamanho);
    if (tamanho > 3) {
        var busca = $("#empresaEdit").val();
        $.ajax({
            type: 'POST',
            url: 'http://192.168.1.61/crmFonetalk/contatos/buscaEmpresa/' + busca,
            cache: false,
            ...
            success: function (json) {
                console.log(json);
                $("#respostaEmpresaEdit").find('ul').html('');
                json.forEach(montaEmpresasSelecionaEdit);
                $('#respostaEmpresaEdit').slideDown('slow');
            },
            error: function (e) {//executa se der erro em algum lugar
                alert("erro ao deletar" + e);
            }
...
function montaEmpresasSelecionaEdit(value, index, ar) {
    $("#respostaEmpresaEdit").find('ul').append('<li ><a onclick="escolhaEmpresaEdit(' + value.id + ', \' ' + value.nome + ' \', \' ' + value.cargo + ' \' );" >' + value.nome + '</a></li>');
}

function escolhaEmpresaEdit(id, nome, cargo) {
    $("#empresaEdit").val(nome);
    $("#idBuscaEmpresaEdit").val(id);
    $("#cargoEdit").val(cargo);
    $('#respostaEmpresaEdit').slideUp('slow');
}


$('#negocio').keyup(function () {
    var tamanho = $("#negocio").val().length;
    console.log(tamanho);
    if (tamanho > 3) {
        var busca = $("#negocio").val();
        $.ajax({
            type: 'POST',
            url: 'http://192.168.1.61/crmFonetalk/atividades/buscaNegocio/' + busca,
            cache: false,
            dataType: 'json',
            success: function (json) {
                console.log(json);
                $("#respostaNegocio").find('ul').html('');
                json.forEach(montaNegocioSeleciona);
                $('#respostaNegocio').slideDown('slow');
            },
            error: function (e) {//executa se der erro em algum lugar
                alert("erro ao deletar" + e);
            }
...
function montaNegocioSeleciona(value, index, ar) {
    $("#respostaNegocio").find('ul').append('<li ><a onclick="escolhaNegocio(' + value.id + ', \' ' + value.nome + ' \' );" >' + value.nome + '</a></li>');
}

function escolhaNegocio(id, nome) {
    $("#negocio").val(nome);
    $("#idBuscaNegocio").val(id);
    $('#respostaNegocio').slideUp('slow');
}
$('#negocioEdit').keyup(function () {
    var tamanho = $("#negocioEdit").val().length;
    console.log(tamanho);
    if (tamanho > 3) {
        var busca = $("#negocioEdit").val();
        $.ajax({
            type: 'POST',
            url: 'http://192.168.1.61/crmFonetalk/atividades/buscaNegocio/' + busca,
            cache: false,
            ...
            success: function (json) {
                console.log(json);
                $("#respostaNegocioEdit").find('ul').html('');
                json.forEach(montaNegocioSelecionaEdit);
                $('#respostaNegocioEdit').slideDown('slow');
            },
            error: function (e) {//executa se der erro em algum lugar
                alert("erro ao deletar" + e);
            }
...
function montaNegocioSelecionaEdit(value, index, ar) {
    $("#respostaNegocioEdit").find('ul').append('<li ><a onclick="escolhaNegocioEdit(' + value.id + ', \' ' + value.nome + ' \' );" >' + value.nome + '</a></li>');
}

function escolhaNegocioEdit(id, nome) {
    $("#negocioEdit").val(nome);
    $("#idBuscaNegocioEdit").val(id);
    $('#respostaNegocioEdit').slideUp('slow');
}
...
//            console.log(json);
            ...
            if (json != 'vazio') {
                $('.tabela').find('tbody').html('');
                json.forEach(montaTabelaRelatorio);
            }
            $('.tabela').DataTable({
                "aaSorting": [[0, "asc"]],
                "oLanguage": {
...
function montaTabelaRelatorio(value, index, ar) {
    var cor = '';
    var tipo = '';
...
//    var btnEdit = '<button class="btnedit btn btn-secondary btn-sm" onclick="editEmpresa(' + value.id + ');"  ><i class="fa fa-edit"></i></button>';
    $('.tabela').find('tbody').append(
            '<tr><td ' + cor + ' >' + value.nome + '</td><td ' + cor + '>' + value.atual + '</td><td ' + cor + '>' + value.ganho + '</td><td ' + cor + '>' + value.perdido + '</td><td ' + cor + '>' +value.valor_temporario +' </td><td ' + cor + '>' +value.valor_ganho +' </td><td ' + cor + '>' +value.valor_temporario +' </td></tr>'
            );
}